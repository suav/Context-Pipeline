/**
 * Base AI Service - Shared functionality for all AI services
 */
...
export abstract class BaseAIService {
  ...
  /**
   * Abstract methods that each AI service must implement
   */
  ...
  /**
   * Load workspace context - shared across all AI services
   */
  ...
  /**
   * Build system prompt - shared across all AI services
   */
...
Be helpful, accurate, and focused on the development tasks at hand.`;
  ...
  /**
   * Spawn process with proper cleanup - shared utility
   */
  ...
  /**
   * Create fallback stream for simple text responses
   */
